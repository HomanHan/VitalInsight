...
<div style="height: auto;
  ...
  font-size: 12px">
        ...
        <div style="text-align: center;
            ...
            Copyright &copy;${.now?string("yyyy")} <a hover="color: #DA251D;" style="color: #999;" href="https://github.com/elunez/VitalInsight" target="_blank">VitalInsight</a> All Rights Reserved.
        </div>
